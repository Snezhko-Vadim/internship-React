...
const Standings = ({isLoading, error, selectedTypeOfStandingsTable, currentStandings, idOfCompetition, fetchStandings}) => {
    ...
    return(
        <div className = 'standing'>
            ...
            <div className = 'standing__tables'>
                {
                    currentStandings.standings.map((standingsItem, index) => {
...
const mapDispatchToProps = ((dispatch)=>{
    return{
        fetchStandings: (compId) => dispatch(fetchStandings(compId)),
    }
})
